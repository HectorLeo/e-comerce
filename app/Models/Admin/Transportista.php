...
class Transportista extends Model
{
    ...
    protected $fillable = ['envio_gratis','nombre_transporte','estado_transporte','logotipo_transporte','retraso_transporte','facturacion','impuestos','fuera_rango','r_mayorigual','r_menor','anchura','altura','profundidad','peso'];
