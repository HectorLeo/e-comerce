$(document).ready(function () {
    $('.ventana_popup').click(function (e) {
        ...
        $.ajax({
            ...
            success: function (resul) {
                ...
                if(precioD == 0){
                    $('#precio_popup').html('<h3 class="product-price">$'+precioN+' <del class="product-old-price"></del></h3>');
                }
    ...
    $('.ventana_popup2').click(function (e) {
        e.preventDefault();
        $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    ...
    $('.ventana_popup_client').click(function (e) {
        e.preventDefault();
        $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    ...
    $('.ventana_popup_client2').click(function (e) {
        e.preventDefault();
        $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
