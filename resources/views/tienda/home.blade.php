                    ...
                    <div class="section-title">
                        ...
                        <div class="section-nav">
                            <ul class="section-tab-nav tab-nav">
                                ...
                                <li class=""><a data-toggle="tab" href="#tab2">Oferta</a></li>
                                <li class=""><a data-toggle="tab" href="#tab1">Exclusivos</a></li>
                                <li class=""><a data-toggle="tab" href="#tab1">Los más vendidos</a></li>
                            </ul>
                        </div>
                ...
                <div class="col-md-12">
					...
					<div class="col-md-12">
						<div id="product-tab">
							<!-- product tab nav -->
							<ul class="tab-nav">
								<li class="active"><a data-toggle="tab" href="#tab11">Description</a></li>
								<li><a data-toggle="tab" href="#tab12">Details</a></li>
								<li><a data-toggle="tab" href="#tab13">Reviews (3)</a></li>
							</ul>
							<!-- /product tab nav -->
