				...
				<div class="row">
					...
					<div class="col-md-7">
						...
						<div class="billing-details">
							...
							<div class="form-group">
								<input class="input" type="text" name="paterno" placeholder="Apellido Paterno">
                            </div>
                            <div class="form-group">
								<input class="input" type="text" name="materno" placeholder="Apellido Materno">
							</div>
							<div class="form-group">
								<input class="input" type="email" name="email" placeholder="Correo electrónico">
							</div>
							<div class="form-group">
								<input class="input" type="text" name="diereccion" placeholder="Dirección">
							</div>
							<div class="form-group">
